...
# -o ./objs/3D_MT/GFortReleaseMPI_SP (output directory for object files)
...
$(OBJDIR)/solver.o:3D_MT/FWD_SP/solver.f90 $(OBJDIR)/math_constants.o $(OBJDIR)/utilities.o $(OBJDIR)/spOpTools.o $(OBJDIR)/modelOperator3D.o $(OBJDIR)/modelOperator3D.o $(OBJDIR)/modelOperator3D.o 
